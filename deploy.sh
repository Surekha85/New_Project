...
STACK_NAME="jobsyme-job-offer-${STAGE}"
FINAL_TEMPLATE="portals/candidate.yml"
S3_BUCKET="jobsyme-job-offer-infra-${STAGE}"
S3_PREFIX="jobsyme-job-offer/$STAGE"
